...
**
**
**  Below is the position of data elements in the Dive/Synchro.txt file generated by DR2Video.  Now not used but left here for reference.  Will need to generate a new mapping for the UDP data stream!
...
local function update(k, v)
    ...
    if v then -- Is second line of data(v) present? Just checking again!
        ...
        if split_string2[1]  ~= "REFEREE" then return end   -- don't process other UDP data packets at this time!!
    end
