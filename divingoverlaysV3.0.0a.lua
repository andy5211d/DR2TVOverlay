...
**                                  split_string2[4]
**                                  split_string2[5]            Sending Computer IP Address
...
**                                  split_string2[39]
**                                  split_string2[40]
**        Meet Name                 split_string2[41]
**        Meet Year                 split_string2[42]
**        Next Event Label?         split_string2[43]
**        Next Event                split_string2[44]
**                                  split_string2[45]
**                                  split_string2[46]
**                                  split_string2[47]
**                                  split_string2[48]
...
**        No of Rounds              split_string2[63]
**        No of Divers              split_string2[64]
**        Dive Description          split_string2[65]
**        Short Event Name          split_string2[66]
**                                  split_string2[67]
**                                  split_string2[68]
**                                  split_string2[69]
**                                  split_string2[70]
...
local portClient = 58091            -- the main port for DR broadcasts
...
function script_description()
    return [[<center><h2>Display DiveRecorder Data as a Video Overlay</h></center>
             <p>Display diver and scores from DiveRecorder for individual and synchro diving events.  DR2Video text file & path must be entered for main individual (Dive.txt) and for synchro event (Synchro.txt) or the B file if the other event required.  Trigger file locations (DUpdate.txt & SUpdate.txt) need to be entered to trigger an update of the DR data .txt files.  The approporate OBS Source .json file must be imported into OBS for this video overlay to function correctly.  </p><p>Andy - V3.0.0 2022Jul05</p>]]
end
--[[
