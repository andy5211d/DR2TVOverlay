...
with Diverecorder and OBS-Studio.  Use the latest version, others kept for reference during ongoing development.
...
the necessary JSON source file available in this repository.  It is unlikely that the V1.n.n script and associated layout will
...
user for first run.  On screen status and script information needed to know state of hotkey toggles.