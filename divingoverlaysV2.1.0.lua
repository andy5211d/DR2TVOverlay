...
hk = {}
key_1 = '{ "htk_1": [ { "key": "OBS_KEY_F3" } ], '   -- HK to disableUpdate_overlays
key_2 = '  "htk_2": [ { "key": "OBS_KEY_F1" } ], '   -- HK to temp display_overlays (all)
key_3 = '  "htk_3": [ { "key": "OBS_KEY_F2" } ], '   -- HK to temp remove_overlays
...
default_hotkeys =
    {
    {id='htk_1', des='Disable Update of Overlays ',  callback=disableUpdate_overlays},
    {id='htk_2', des='Temporary Display All DR2TVOverlays ',  callback=display_overlays},
    {id='htk_3', des='Temporary Remove All DR2TVOverlays ',   callback=remove_overlays},
