...
**             2023-09-29  More code clean-ups.
...
**    V3.3.0   2023-11-08  'single_update' re-factored to match 'simultaneous_update' format and also both simplified.  Few wrinkles in the display formating but working for both single event and simultaneous
**                         event modes.
...
**    V3.3.2   2023-11-23  Added capability to swap overlay positions when in Simultaneous mode using the F10 key.  Added F8 and F6 in Simultaneous mode to clear Left and Right displays respectively. Fixed Penalty bug.
**    V3.3.3   2024-04-07  Minor clorrections.  F6 labels for the different F12 modes now seperated and show correctly.
**    V3.3.4   2024-06-15  Removed redundent F8 display background in Simultaneous mode.  Only 2 UDP ports monitored.
**    V3.3.5   2024-07-02  F6 background now correct in Simultaneous mode even if Event B is in Individual mode when switched.  Event Complete indicator removed in Simultaneous mode.
**  
...
positionText = {   -- not used in V3.3.n yet
    A  = ", straight",
    B  = ", piked",
    C  = ", tucked",
    D  = ", free position"
...
penaltyText = {    -- not used in V3.3.n yet
    " ",
    "   Failed Dive ",
    "    Restarted \n    -2 points ",
    "Flight or Danger\n Max 2 points ",
...
function script_description()
    return [[<center><h2>Display DiveRecorder Data as a Video Overlay or Overlays</h></center>
             <p>Display diver and scores from DiveRecorder for single individual or synchro diving event or simultaneous individual events.  The approporate OBS Source (.json) file must be imported into OBS for this video overlay to function correctly. You must be connected to the same Class C sub-net as the DR computers. </p><p>Andy - V3.3.5 2024Jul02</p>]]
end
