...
**    V3.4.0   2024-07-04  Code simplified to monitor only one UDP port.  Noticed at last event that rendering errors occure at 60fps even with i9 and nVid4070 laptop doing the processing!  Other ports
...
function script_description()
    return [[<center><h2>Display DiveRecorder Data as a Video Overlay or Overlays</h></center>
             <p>Display diver and scores from DiveRecorder for single individual or synchro diving event or simultaneous individual events.  The approporate OBS Source (.json) file must be imported into OBS for this video overlay to function correctly. You must be connected to the same Class C sub-net as the DR computers. </p><p>Andy - V3.4.0 2024Jul04</p>]]
end
