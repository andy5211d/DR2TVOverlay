...
function toggle_event_position(pressed)  -- F10 Hotkey to toggle Event overlay or Event A or B positions
    ...
    if simultaneousEvents then --F10 for simultaneous events to swap event A and B positions (but actually does nothing at present other than change status area)
...
function script_description()
    return [[<center><h2>Display DiveRecorder Data as a Video Overlay or Overlays</h></center>
             <p>Display diver and scores from DiveRecorder for single individual or synchro diving event or simultaneous individual events.  The approporate OBS Source (.json) file must be imported into OBS for this video overlay to function correctly. You must be connected to the same Class C sub-net as the DR computers. </p><p>Andy - V3.3.3 2024Apr07</p>]]
end
