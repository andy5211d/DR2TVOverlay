...
--[[
    if v then -- Is second line of data(v) present? Just checking again!
        ...
        if split_string2[1]  ~= "REFEREE" then return end   -- don't process other port 58091 UDP data messages at this time, only REFEREE message       
...
local function processMessage(k, v, x)
    if k then -- Is there a first port message present (k)?
    ...
    --[[
    if v then -- Is there a second port message present (v)?
    ...
    if x then -- Is there a third port message present (x)?
