...
function UDPtimer_callback()  -- commented out until fully understood!
...
function init()
    ...
    activeId = activeId + 1
--[[
    local address = socket.find_first_address("*", portClient)  -- udp experement 
...
function script_description()
    return [[<center><h2>Display DiveRecorder Data as a Video Overlay</h></center>
             <p>Display diver and scores from DiveRecorder for individual and synchro diving events.  DR2Video text file & path must be entered for main individual (Dive.txt) and for synchro event (Synchro.txt) or the B file if the other event required.  Trigger file locations (DUpdate.txt & SUpdate.txt) need to be entered to trigger an update of the DR data .txt files.  The approporate OBS Source .json file must be imported into OBS for this video overlay to function correctly.  </p><p>Andy - V2.1.1 2022Jul04</p>]]
end
--[[
